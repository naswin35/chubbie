...
public class MyOrders extends BaseActivity {
    ...
    ArrayList<OrderListModel>MyOrders=new ArrayList<>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        getLayoutInflater().inflate(R.layout.activity_my_orders,frameLayout);
        ...
        mTitle.setText(R.string.my_orders);
        ...
        MyOrdersList=findViewById(R.id.Myorders);
    ...
    public static MyOrders getMyOrders(){

        return myOrders;
    }


    private class FetchMyOrders extends AsyncTask<String, Void, JSONObject> {
        ...
        String Token;
        public FetchMyOrders(String url) {
        ...
        protected void onPreExecute(){
            ...
            super.onPreExecute();
            mProgressHUD = ProgressHUD.show(MyOrders.this,null, true);
            ...
            if(json!=null) {
                ...
                if (json.has("error")) {
                    ...
                    if (status.equals("ok")) {
                        ...
                        JSONObject customer_order_items = data.optJSONObject("customer_order_items");
                        ...
                        if (OrderList != null && OrderList.length() > 0) {
                            ...
                            for (int i = 0; i < OrderList.length(); i++) {
                                ...
                                orderListModel.setCustomer_order_created_at(dates.getDate(obj.optString("customer_order_created_at")));

                                orderListModel.setProductImage(obj.optString("product_image"));

                                orderListModel.setCustomer_order_total_price(obj.optString("customer_order_total_price"));

                                MyOrders.add(orderListModel);
                            ...
                            if (adapter != null && adapter.getItemCount() > 0) {
                                ...
                                adapter = new OrderListAdapter(MyOrders.this, MyOrders);
                                MyOrdersList.setAdapter(adapter);
                                MyOrdersList.setHasFixedSize(true);
                                MyOrdersList.setNestedScrollingEnabled(false);
                                MyOrdersList.setLayoutManager(new LinearLayoutManager(MyOrders.this, LinearLayoutManager.VERTICAL, false));
                                adapter.notifyDataSetChanged();
                            ...
                            ViewmoreAction.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    ...
                                    if (internet_status) {
                                        ...
                                        new FetchMyOrders(nextpathurl).execute();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            ...
            case R.id.action_cart:
                ...
                {
                    Intent i= new Intent(MyOrders.this,CartActivity.class) ;
                    startActivity(i);
                }
                else
                        ...
                        if(isConnectedToInternet){
                            ...
                            if(session.isLoggedIn()) {
                                if (SessionLogined.equals("true")) {
                                    ...
                                    new FetchMyOrders(ApiLinks.specificCustomerOrderItemList + user.get(SessionManager.KEY_CUSTOMER_ID)).execute();
                                    initTypeface();
